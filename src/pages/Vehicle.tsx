...
// import { updateVehicle, saveVehicle, removeVehicle } from "../reducers/VehicleSlice.tsx";
          ...
          <table className="w-full text-left table-auto min-w-max bg-white rounded-md">
            <thead>
              <tr>
                ...
                <th className="p-4 border-b border-blue-gray-100 bg-blue-gray-50">
                  <p className="text-gray-500 font-bold">license plate number</p>
                </th>
                <th className="p-4 border-b border-blue-gray-100 bg-blue-gray-50">
                  <p className="text-gray-500 font-bold">Vehicle Category</p>
                </th>
                <th className="p-4 border-b border-blue-gray-100 bg-blue-gray-50">
                  <p className="text-gray-500 font-bold">Fuel Type</p>
                </th>
                <th className="p-4 border-b border-blue-gray-100 bg-blue-gray-50">
                ...
                <th className="p-4 border-b border-blue-gray-100 bg-blue-gray-50">
                  <p className="text-gray-500 font-bold">member name</p>
                </th>
